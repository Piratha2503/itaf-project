...
public class DesignationController {
    ...
    public ResponseEntity<Object> getAllDesignationsByCompanyId(@PathVariable Long userId) {

        if (!userService.existsByUserId(userId)) {
            return ResponseEntity.ok(new BaseResponse(RequestStatus.FAILURE.getStatus(), statusCodeBundle.getUserNotExistsCode(), statusCodeBundle.getCompanyUserIdNotExistMessage()));
        }
        List<DesignationResponse> designations = designationService.getAllDesignationByCompanyId(userId);
        ...
        return ResponseEntity.ok(new ContentResponse<>(Constants.DESIGNATIONS, designationService.getAllDesignationByCompanyId(userId), RequestStatus.SUCCESS.getStatus(), statusCodeBundle.getCommonSuccessCode(), statusCodeBundle.getGetDesignationSuccessMessage()));
    }
